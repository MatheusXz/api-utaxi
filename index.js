...
app.listen(8800, () => {
        console.log("Ok connection! http://localhost:8800/")
    })
    // conexão com o banco
...
app.post("/usuarios", (req, res) => {
    const sql = "INSERT  INTO `Usuarios`(`usu_nome`,`usu_email`,`usu_cpf`,`usu_senha`,`usu_rg`,`usu_dt_nascimento`,`usu_telefone`,`usu_celular`,`usu_genero`,`usu_dt_cadastro`,`usu_tipo`,`usu_status`) VALUES (?)";
    const values = [
        "Matheus",
        "matheus@gmail.com",
        "50912545875",
